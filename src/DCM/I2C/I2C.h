...
public:
	...
	*/
	 ...
	 * @param[in] nRAMBaseLine The base line number in BRAM
	 * @param[in] nDRAMBaseLine The base line number in BRAM
	 * @return Execute result
	 * - 0 Set the base line successfully
	 * - -1 The BRAM line available is not enough
	 * - -2 The DRAM line available is not enough
	*/
	int SetBaseLine(int nRAMBaseLine, int nDRAMBaseLine);
	/**
