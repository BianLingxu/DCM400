 ...
 * @brief The debug tool of the TMU measurement result
...
/**
 * @class CHDDebugToolItemTMUMeas
 * @brief The debug tool class of the TMU measurement result
*/
class CHDDebugToolItemTMUMeas :
...
public:
    ...
    */
    CHDDebugToolItemTMUMeas(HDDebugTool* pDebugTool);
    /**
     * @brief Destructor
    */
    ~CHDDebugToolItemTMUMeas();
	/**
