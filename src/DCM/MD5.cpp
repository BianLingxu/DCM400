...
void fopen_safe(FILE** ppFile, const char* lpszFileName, const char* lpszMode)
{
#if defined(_MSC_VER) && 1400 <=_MSC_VER
    fopen_s(ppFile, lpszFileName, lpszMode);
#else
   *ppFile = fopen(lpszFileName, lpszMode);
#endif // defined(_MSC_VER) && 1400 <=_MSC_VER
}
