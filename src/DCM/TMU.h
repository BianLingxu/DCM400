...
private:
	...
	*/
	UINT GetControllerID(BYTE bySlotNo, BYTE byControllerIndex);	
private:
	std::map<UINT, USHORT*> m_mapChannel;///<The channel of each TMU unit
	std::map<UINT, BYTE*> m_mapMode;///<The mode of each TMU unit
	std::map<UINT, BYTE*> m_mapTriggerEdge;///<The trigger edge of each TMU unit
	std::map<UINT, USHORT*> m_mapHoldOffTime;///<The hold off time of each TMU unit
	std::map<UINT, USHORT*> m_mapHoldOffNum;///<The hold off number of each TMU unit
	std::map<UINT, USHORT*> m_mapSampleNum;///<The sample number of each TMU unit
	std::map<UINT, float*> m_mapTimeout;///<The timeout of each TMU unit
};
