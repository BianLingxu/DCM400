...
private:
	...
	*/
	 ...
	 * @param[in] setStartLineNo The start line number of fail saved
	 * @param[in] setStopLineNo The stop line number of fail saved
	...
	*/
	int LoadPattern(const std::set<UINT>& setStartLineNo, const std::set<UINT>& setStopLineNo, std::set<UINT>& setBRAMOut, std::set<UINT>& setDRAMIn, BOOL bAllFail = FALSE);
private:
