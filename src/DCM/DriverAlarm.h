...
private:
	...
	BOOL m_bClearInfo;///<Whether clear alarm infomation
};
/**
 * @class CAlarmManage
 * @brief The class for class CDriverAlarm management
*/
class CAlarmManage
{
public:
	/**
	 * @brief Get the instance of class CAlarmManage
	 * @return The point of the instance
	*/
	static CAlarmManage* Instance();
	/**
	 * @brief Get the alarm of the instance ID
	 * @param[in] nInstanceID The instance ID
	 * @return The point of class CDriverAlarm for the instance
	*/
	CDriverAlarm* GetAlarm(int nInstanceID);
	/**
	 * @brief Delete the class CDriverAlarm for the instance
	 * @param[in] nInstanceID The instance ID
	*/
	void DeleteAlarm(int nInstanceID);
private:
	/**
	 * @brief Constructor
	*/
	CAlarmManage();
	/**
	 * @brief The operation of class CDriverAlarm management
	 * @param[in] nInstanceID The instance ID
	 * @param[in] bDelete Whether delete the class CDriverAlarm for the instance
	 * @return The point of the class CDriverAlarm for the instance
	*/
	CDriverAlarm* Operation(int nInstanceID, BOOL bDelete);
private:
	std::map<int, CDriverAlarm*> m_mapAlarm;
	CRITICAL_SECTION m_criOperation;///<The critical section for ensure
};