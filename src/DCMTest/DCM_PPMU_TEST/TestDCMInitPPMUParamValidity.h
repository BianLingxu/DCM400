#pragma once
/**
 * @file TestDCMInitPPMUParamValidity.h
 * @copyright AccoTEST Business Unit of Beijing Huafeng Test & Controller Co., Ltd.
 * @author Guangyun Wang
 * @date 2020/07/16
 * @version v 1.0.0.0
 * @brief Test the parameter validity of InitPPMU
 */
#include "..\DCMTestMain.h"
#define SITE_PER_BOARD 4
XT_TEST(PMUParamValidityTest, TestDCMInitPPMUParamValidity)
{
	string strFuncName;
	...
	{
		nRetVal = dcm.InitPPMU(lpszPinGroup);
