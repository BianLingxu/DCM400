#pragma once
/*!
* @file      TestDCMGetMCUResultRunningTime.h
*
...
* @date      2017/12/12
* @version   v 1.0.0.0
* @brief     测试GetMCUResult运行时间
* @comment
*/
#include "..\DCMTestMain.h"
XT_TEST(FunctionRunningTimeTest, TestDCMGetMCUResultRunningTime)
{
	string strFuncName;
	...
	dcm.GetMCUResult(iterSlot->second);
	timeReport.timeStop();
