#pragma once
/*!
* @file      TestDCMGetMCUPinResultParamValidity.h
*
...
XT_TEST(ParamValidityTest, TestDCMGetMCUPinResultParamValidity)
{
	string strFuncName;
	...
	nRetVal = dcm.GetMCUPinResult(nullptr, 0);
	...
	for (int nPinNameIndex = 0; nPinNameIndex < nPinNameTestCount; ++nPinNameIndex)
	{
		...
		{
			nRetVal = dcm.GetMCUPinResult(pinName[nPinNameIndex], uSiteID);
