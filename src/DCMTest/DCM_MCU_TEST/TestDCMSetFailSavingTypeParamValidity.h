#pragma once
/**
 * @file TestDCMSetFailSavingTypeParamValidity.h
...
XT_TEST(ParamValidityTest, TestDCMSetFailSavingTypeParamValidity)
{
	string strFuncName;
	...
	{
		nRetVal = dcm.SetFailSavingType(lpszPinGroup, DCM_SAVING_ALL_FAIL);
