#pragma once
/*!
* @file      TestDCMGetMCUPinRunStatusRunningTime.h
*
...
* @date      2017/12/12
* @version   v 1.0.0.0
* @brief     测试GetMCUPinRunStatus运行时间
* @comment
*/
#include "..\DCMTestMain.h"
XT_TEST(FunctionRunningTimeTest, TestDCMGetMCUPinRunStatusRunningTime)
{
	string strFuncName;
	...
	dcm.GetMCUPinRunStatus("CH0", iterSlot->second);
	timeReport.timeStop();
	timeReport.addMsg("Vector Finish");
	...
	dcm.GetMCUPinRunStatus("CH0", iterSlot->second);
	timeReport.timeStop();
	timeReport.addMsg("Vector Running");
