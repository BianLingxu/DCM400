#pragma once
/**
 * @file TestDCMSetOperandFunction.h
...
XT_TEST(FunctionFunctionTest, TestDCMSetOperandFunction)
{
	string strFuncName;
	...
	funcReport.AddTestItem("Check number operand");
	...
	double dBackupNumber = 0;
	
	dBackupNumber = dcm_GetOperand(mapSlot.begin()->first, 0, nLineNumber);
	...
	dcm.SetInstruction("G_ALLPIN", lpszLabel, nLineOffset, "JUMP", lpszSetNum);
