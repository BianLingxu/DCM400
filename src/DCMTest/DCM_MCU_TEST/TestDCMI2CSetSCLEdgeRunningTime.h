#pragma once
/*!
* @file      TestDCMI2CSetSCLEdgeRunningTime.h
*
...
* @date      2020/02/04
* @version   v1.0.0.0
* @brief     测试I2CSetSCLEdge运行时间
* @comment
*/
#include "..\DCMTestMain.h"
XT_TEST(FunctionRunningTimeTest, TestDCMI2CSetSCLEdgeRunningTime)
{
	string strFuncName;
