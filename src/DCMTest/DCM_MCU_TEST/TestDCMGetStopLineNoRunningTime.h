#pragma once
/*!
* @file      TestDCMGetStopLineNoRunningTime.h
*
...
* @date      2017/11/16
* @version   v 1.0.0.0
* @brief     测试GetStopLineNo运行时间
* @comment
*/
#include "..\DCMTestMain.h"

XT_TEST(FunctionRunningTimeTest, TestDCMGetStopLineNoRunningTime)
{
	string strFuncName;
	...
	dcm.GetStopLineNo(iterSlot->second, ulStopLineNo);
	timeReport.timeStop();
