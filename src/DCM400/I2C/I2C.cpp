...
// 	}
// 	m_dPeriod = dPeriod;
// 	int nMaxSiteCount = DCM400_MAX_SITE_COUNT / 2;
...
// 		m_pAlarm->SetAlarmMsg("The point pointed to write data of SITE_%d is nullptr.", usSiteNo + 1);
// 		return -4;
// 	}
...
// }
// 
// int CI2C::SetBaseLine(int nBaseLine)
// {
// 	if (DCM400_PATTERN_LINE_COUNT <= nBaseLine)
// 	{
// 		return -1;
// 	}
// 	m_pRAMManage->Reset();
// 	m_pRAMManage->SetBaseLine(nBaseLine);
...
// 				Channel.m_usChannel, usCurSiteNo + 1, strSitePin.c_str(), DCM400_MAX_CHANNELS_PER_BOARD - 1);
// 			nRetVal = -7;
// 			break;
// 		}
// 
